...
test('builds prepublish release asset checks for every npm target', () => {
  assert.deepEqual(prepublishCheck.expectedReleaseUrls('0.1.0'), [
    'https://github.com/doggy8088/leak-hunter/releases/download/v0.1.0/leak-hunter-aarch64-apple-darwin.tar.xz',
    'https://github.com/doggy8088/leak-hunter/releases/download/v0.1.0/leak-hunter-aarch64-apple-darwin.tar.xz.sha256',
    'https://github.com/doggy8088/leak-hunter/releases/download/v0.1.0/leak-hunter-x86_64-apple-darwin.tar.xz',
    'https://github.com/doggy8088/leak-hunter/releases/download/v0.1.0/leak-hunter-x86_64-apple-darwin.tar.xz.sha256',
    'https://github.com/doggy8088/leak-hunter/releases/download/v0.1.0/leak-hunter-x86_64-unknown-linux-gnu.tar.xz',
    'https://github.com/doggy8088/leak-hunter/releases/download/v0.1.0/leak-hunter-x86_64-unknown-linux-gnu.tar.xz.sha256',
    'https://github.com/doggy8088/leak-hunter/releases/download/v0.1.0/leak-hunter-x86_64-pc-windows-msvc.zip',
    'https://github.com/doggy8088/leak-hunter/releases/download/v0.1.0/leak-hunter-x86_64-pc-windows-msvc.zip.sha256',
  ]);
});
